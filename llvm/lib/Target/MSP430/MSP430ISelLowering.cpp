  ...
  if (STI.hasHWMult16()) {
    const struct {
      ...
      const RTLIB::LibcallImpl Impl;
        ...
        {RTLIB::Libcall::MUL_I16, RTLIB::LibcallImpl::__mspabi_mpyi_hw},
        {RTLIB::Libcall::MUL_I32, RTLIB::LibcallImpl::__mspabi_mpyl_hw},
        {RTLIB::Libcall::MUL_I64, RTLIB::LibcallImpl::__mspabi_mpyll_hw},
    ...
    const struct {
      ...
      const RTLIB::LibcallImpl Impl;
        ...
        // Integer Multiply - EABI Table 9
        {RTLIB::Libcall::MUL_I16, RTLIB::LibcallImpl::__mspabi_mpyi_hw},
        {RTLIB::Libcall::MUL_I32, RTLIB::LibcallImpl::__mspabi_mpyl_hw32},
        {RTLIB::Libcall::MUL_I64, RTLIB::LibcallImpl::__mspabi_mpyll_hw32},
    ...
    const struct {
      ...
      const RTLIB::LibcallImpl Impl;
        ...
        // Integer Multiply - EABI Table 9
        {RTLIB::Libcall::MUL_I16, RTLIB::LibcallImpl::__mspabi_mpyi_f5hw},
        {RTLIB::Libcall::MUL_I32, RTLIB::LibcallImpl::__mspabi_mpyl_f5hw},
        {RTLIB::Libcall::MUL_I64, RTLIB::LibcallImpl::__mspabi_mpyll_f5hw},
    ...
    const struct {
      ...
      const RTLIB::LibcallImpl Impl;
        ...
        // Integer Multiply - EABI Table 9
        {RTLIB::Libcall::MUL_I16, RTLIB::LibcallImpl::__mspabi_mpyi},
        {RTLIB::Libcall::MUL_I32, RTLIB::LibcallImpl::__mspabi_mpyl},
        {RTLIB::Libcall::MUL_I64, RTLIB::LibcallImpl::__mspabi_mpyll},
