...
static const Mips16Libcall HardFloatLibCalls[] = {
    {RTLIB::Libcall::ADD_F64, RTLIB::LibcallImpl::__mips16_adddf3, "__mips16_adddf3"},
    {RTLIB::Libcall::ADD_F32, RTLIB::LibcallImpl::__mips16_addsf3, "__mips16_addsf3"},
    {RTLIB::Libcall::DIV_F64, RTLIB::LibcallImpl::__mips16_divdf3, "__mips16_divdf3"},
    {RTLIB::Libcall::DIV_F32, RTLIB::LibcallImpl::__mips16_divsf3, "__mips16_divsf3"},
    {RTLIB::Libcall::OEQ_F64, RTLIB::LibcallImpl::__mips16_eqdf2, "__mips16_eqdf2"},
    {RTLIB::Libcall::OEQ_F32, RTLIB::LibcallImpl::__mips16_eqsf2, "__mips16_eqsf2"},
    {RTLIB::Libcall::FPEXT_F32_F64, RTLIB::LibcallImpl::__mips16_extendsfdf2, "__mips16_extendsfdf2"},
    {RTLIB::Libcall::FPTOSINT_F64_I32, RTLIB::LibcallImpl::__mips16_fix_truncdfsi,
     "__mips16_fix_truncdfsi"},
    {RTLIB::Libcall::FPTOSINT_F32_I32, RTLIB::LibcallImpl::__mips16_fix_truncsfsi,
     "__mips16_fix_truncsfsi"},
    {RTLIB::Libcall::SINTTOFP_I32_F64, RTLIB::LibcallImpl::__mips16_floatsidf, "__mips16_floatsidf"},
    {RTLIB::Libcall::SINTTOFP_I32_F32, RTLIB::LibcallImpl::__mips16_floatsisf, "__mips16_floatsisf"},
    {RTLIB::Libcall::UINTTOFP_I32_F64, RTLIB::LibcallImpl::__mips16_floatunsidf,
     "__mips16_floatunsidf"},
    {RTLIB::Libcall::UINTTOFP_I32_F32, RTLIB::LibcallImpl::__mips16_floatunsisf,
     "__mips16_floatunsisf"},
    {RTLIB::Libcall::OGE_F64, RTLIB::LibcallImpl::__mips16_gedf2, "__mips16_gedf2"},
    {RTLIB::Libcall::OGE_F32, RTLIB::LibcallImpl::__mips16_gesf2, "__mips16_gesf2"},
    {RTLIB::Libcall::OGT_F64, RTLIB::LibcallImpl::__mips16_gtdf2, "__mips16_gtdf2"},
    {RTLIB::Libcall::OGT_F32, RTLIB::LibcallImpl::__mips16_gtsf2, "__mips16_gtsf2"},
    {RTLIB::Libcall::OLE_F64, RTLIB::LibcallImpl::__mips16_ledf2, "__mips16_ledf2"},
    {RTLIB::Libcall::OLE_F32, RTLIB::LibcallImpl::__mips16_lesf2, "__mips16_lesf2"},
    {RTLIB::Libcall::OLT_F64, RTLIB::LibcallImpl::__mips16_ltdf2, "__mips16_ltdf2"},
    {RTLIB::Libcall::OLT_F32, RTLIB::LibcallImpl::__mips16_ltsf2, "__mips16_ltsf2"},
    {RTLIB::Libcall::MUL_F64, RTLIB::LibcallImpl::__mips16_muldf3, "__mips16_muldf3"},
    {RTLIB::Libcall::MUL_F32, RTLIB::LibcallImpl::__mips16_mulsf3, "__mips16_mulsf3"},
    {RTLIB::Libcall::UNE_F64, RTLIB::LibcallImpl::__mips16_nedf2, "__mips16_nedf2"},
    {RTLIB::Libcall::UNE_F32, RTLIB::LibcallImpl::__mips16_nesf2, "__mips16_nesf2"},
    {RTLIB::Libcall::UNKNOWN_LIBCALL, RTLIB::LibcallImpl::__mips16_ret_dc,
     "__mips16_ret_dc"}, // No associated libcall.
    {RTLIB::Libcall::UNKNOWN_LIBCALL, RTLIB::LibcallImpl::__mips16_ret_df,
     "__mips16_ret_df"}, // No associated libcall.
    {RTLIB::Libcall::UNKNOWN_LIBCALL, RTLIB::LibcallImpl::__mips16_ret_sc,
     "__mips16_ret_sc"}, // No associated libcall.
    {RTLIB::Libcall::UNKNOWN_LIBCALL, RTLIB::LibcallImpl::__mips16_ret_sf,
     "__mips16_ret_sf"}, // No associated libcall.
    {RTLIB::Libcall::SUB_F64, RTLIB::LibcallImpl::__mips16_subdf3, "__mips16_subdf3"},
    {RTLIB::Libcall::SUB_F32, RTLIB::LibcallImpl::__mips16_subsf3, "__mips16_subsf3"},
    {RTLIB::Libcall::FPROUND_F64_F32, RTLIB::LibcallImpl::__mips16_truncdfsf2, "__mips16_truncdfsf2"},
    {RTLIB::Libcall::UO_F64, RTLIB::LibcallImpl::__mips16_unorddf2, "__mips16_unorddf2"},
    {RTLIB::Libcall::UO_F32, RTLIB::LibcallImpl::__mips16_unordsf2, "__mips16_unordsf2"}};
...
void Mips16TargetLowering::setMips16HardFloatLibCalls() {
  for (unsigned I = 0; I != std::size(HardFloatLibCalls); ++I) {
    assert((I == 0 || HardFloatLibCalls[I - 1] < HardFloatLibCalls[I]) &&
           "Array not sorted!");
    if (HardFloatLibCalls[I].Libcall != RTLIB::Libcall::UNKNOWN_LIBCALL)
...
getOpndList(SmallVectorImpl<SDValue> &Ops,
  ...
  if (Subtarget.inMips16HardFloat()) {
    ...
    if (ExternalSymbolSDNode *S = dyn_cast<ExternalSymbolSDNode>(CLI.Callee)) {
      Mips16Libcall Find = {RTLIB::Libcall::UNKNOWN_LIBCALL,
                            RTLIB::LibcallImpl::Unsupported, S->getSymbol()};
      ...
      Mips16Libcall Find = {RTLIB::Libcall::UNKNOWN_LIBCALL, RTLIB::LibcallImpl::Unsupported,
