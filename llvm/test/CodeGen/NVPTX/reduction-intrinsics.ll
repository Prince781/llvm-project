...
; CHECK-SM80-NEXT:    add.rn.f32 %r12, %r7, %r3;
; CHECK-SM80-NEXT:    add.rn.f32 %r13, %r5, %r1;
...
; CHECK-SM80-NEXT:    mul.rn.f32 %r12, %r7, %r3;
; CHECK-SM80-NEXT:    mul.rn.f32 %r13, %r5, %r1;
...
; CHECK-NEXT:    max.f16 %rs9, %rs7, %rs8;
; CHECK-NEXT:    max.f16 %rs10, %rs5, %rs6;
; CHECK-NEXT:    max.f16 %rs11, %rs10, %rs9;
; CHECK-NEXT:    max.f16 %rs12, %rs3, %rs4;
; CHECK-NEXT:    max.f16 %rs13, %rs1, %rs2;
; CHECK-NEXT:    max.f16 %rs14, %rs13, %rs12;
; CHECK-NEXT:    max.f16 %rs15, %rs14, %rs11;
; CHECK-NEXT:    st.param.b16 [func_retval0], %rs15;
; CHECK-NEXT:    ret;
...
; CHECK-NEXT:    max.f16 %rs8, %rs5, %rs6;
; CHECK-NEXT:    max.f16 %rs9, %rs8, %rs7;
; CHECK-NEXT:    max.f16 %rs10, %rs3, %rs4;
; CHECK-NEXT:    max.f16 %rs11, %rs1, %rs2;
; CHECK-NEXT:    max.f16 %rs12, %rs11, %rs10;
; CHECK-NEXT:    max.f16 %rs13, %rs12, %rs9;
...
; CHECK-SM80-EMPTY:
; CHECK-SM80-NEXT:  // %bb.0:
; CHECK-SM80-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fmax_float_param_0+16];
; CHECK-SM80-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fmax_float_param_0];
; CHECK-SM80-NEXT:    max.f32 %r9, %r5, %r6;
; CHECK-SM80-NEXT:    max.f32 %r10, %r9, %r7;
; CHECK-SM80-NEXT:    max.f32 %r11, %r10, %r8;
; CHECK-SM80-NEXT:    max.f32 %r12, %r11, %r1;
; CHECK-SM80-NEXT:    max.f32 %r13, %r12, %r2;
; CHECK-SM80-NEXT:    max.f32 %r14, %r13, %r3;
; CHECK-SM80-NEXT:    max.f32 %r15, %r14, %r4;
; CHECK-SM80-NEXT:    st.param.b32 [func_retval0], %r15;
; CHECK-SM80-NEXT:    ret;
;
...
; CHECK-SM100-EMPTY:
; CHECK-SM100-NEXT:  // %bb.0:
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fmax_float_param_0+16];
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fmax_float_param_0];
; CHECK-SM100-NEXT:    max.f32 %r9, %r5, %r6, %r7;
; CHECK-SM100-NEXT:    max.f32 %r10, %r9, %r8, %r1;
; CHECK-SM100-NEXT:    max.f32 %r11, %r10, %r2, %r3;
; CHECK-SM100-NEXT:    max.f32 %r12, %r11, %r4;
; CHECK-SM100-NEXT:    st.param.b32 [func_retval0], %r12;
; CHECK-SM100-NEXT:    ret;
...
; CHECK-SM100-EMPTY:
; CHECK-SM100-NEXT:  // %bb.0:
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fmax_float_reassoc_param_0+16];
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fmax_float_reassoc_param_0];
; CHECK-SM100-NEXT:    max.f32 %r9, %r8, %r1, %r2;
; CHECK-SM100-NEXT:    max.f32 %r10, %r5, %r6, %r7;
; CHECK-SM100-NEXT:    max.f32 %r11, %r10, %r9, %r3;
; CHECK-SM100-NEXT:    max.f32 %r12, %r11, %r4;
; CHECK-SM100-NEXT:    st.param.b32 [func_retval0], %r12;
; CHECK-SM100-NEXT:    ret;
...
; CHECK-NEXT:    mov.b32 {%rs7, %rs8}, %r4;
; CHECK-NEXT:    min.f16 %rs9, %rs7, %rs8;
; CHECK-NEXT:    min.f16 %rs10, %rs5, %rs6;
; CHECK-NEXT:    min.f16 %rs11, %rs10, %rs9;
; CHECK-NEXT:    min.f16 %rs12, %rs3, %rs4;
; CHECK-NEXT:    min.f16 %rs13, %rs1, %rs2;
; CHECK-NEXT:    min.f16 %rs14, %rs13, %rs12;
; CHECK-NEXT:    min.f16 %rs15, %rs14, %rs11;
; CHECK-NEXT:    st.param.b16 [func_retval0], %rs15;
; CHECK-NEXT:    ret;
...
; CHECK-NEXT:    min.f16 %rs8, %rs5, %rs6;
; CHECK-NEXT:    min.f16 %rs9, %rs8, %rs7;
; CHECK-NEXT:    min.f16 %rs10, %rs3, %rs4;
; CHECK-NEXT:    min.f16 %rs11, %rs1, %rs2;
; CHECK-NEXT:    min.f16 %rs12, %rs11, %rs10;
; CHECK-NEXT:    min.f16 %rs13, %rs12, %rs9;
; CHECK-NEXT:    st.param.b16 [func_retval0], %rs13;
; CHECK-NEXT:    ret;
...
; CHECK-SM80-EMPTY:
; CHECK-SM80-NEXT:  // %bb.0:
; CHECK-SM80-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fmin_float_param_0+16];
; CHECK-SM80-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fmin_float_param_0];
; CHECK-SM80-NEXT:    min.f32 %r9, %r5, %r6;
; CHECK-SM80-NEXT:    min.f32 %r10, %r9, %r7;
; CHECK-SM80-NEXT:    min.f32 %r11, %r10, %r8;
; CHECK-SM80-NEXT:    min.f32 %r12, %r11, %r1;
; CHECK-SM80-NEXT:    min.f32 %r13, %r12, %r2;
; CHECK-SM80-NEXT:    min.f32 %r14, %r13, %r3;
; CHECK-SM80-NEXT:    min.f32 %r15, %r14, %r4;
; CHECK-SM80-NEXT:    st.param.b32 [func_retval0], %r15;
; CHECK-SM80-NEXT:    ret;
;
...
; CHECK-SM100-EMPTY:
; CHECK-SM100-NEXT:  // %bb.0:
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fmin_float_param_0+16];
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fmin_float_param_0];
; CHECK-SM100-NEXT:    min.f32 %r9, %r5, %r6, %r7;
; CHECK-SM100-NEXT:    min.f32 %r10, %r9, %r8, %r1;
; CHECK-SM100-NEXT:    min.f32 %r11, %r10, %r2, %r3;
; CHECK-SM100-NEXT:    min.f32 %r12, %r11, %r4;
; CHECK-SM100-NEXT:    st.param.b32 [func_retval0], %r12;
; CHECK-SM100-NEXT:    ret;
...
; CHECK-SM100-EMPTY:
; CHECK-SM100-NEXT:  // %bb.0:
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fmin_float_reassoc_param_0+16];
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fmin_float_reassoc_param_0];
; CHECK-SM100-NEXT:    min.f32 %r9, %r8, %r1, %r2;
; CHECK-SM100-NEXT:    min.f32 %r10, %r5, %r6, %r7;
; CHECK-SM100-NEXT:    min.f32 %r11, %r10, %r9, %r3;
; CHECK-SM100-NEXT:    min.f32 %r12, %r11, %r4;
; CHECK-SM100-NEXT:    st.param.b32 [func_retval0], %r12;
; CHECK-SM100-NEXT:    ret;
...
; CHECK-SM100-EMPTY:
; CHECK-SM100-NEXT:  // %bb.0:
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fmaximum_float_param_0+16];
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fmaximum_float_param_0];
; CHECK-SM100-NEXT:    max.NaN.f32 %r9, %r8, %r1, %r2;
; CHECK-SM100-NEXT:    max.NaN.f32 %r10, %r5, %r6, %r7;
; CHECK-SM100-NEXT:    max.NaN.f32 %r11, %r10, %r9, %r3;
; CHECK-SM100-NEXT:    max.NaN.f32 %r12, %r11, %r4;
; CHECK-SM100-NEXT:    st.param.b32 [func_retval0], %r12;
; CHECK-SM100-NEXT:    ret;
...
; CHECK-SM100-EMPTY:
; CHECK-SM100-NEXT:  // %bb.0:
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fmaximum_float_reassoc_param_0+16];
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fmaximum_float_reassoc_param_0];
; CHECK-SM100-NEXT:    max.NaN.f32 %r9, %r8, %r1, %r2;
; CHECK-SM100-NEXT:    max.NaN.f32 %r10, %r5, %r6, %r7;
; CHECK-SM100-NEXT:    max.NaN.f32 %r11, %r10, %r9, %r3;
; CHECK-SM100-NEXT:    max.NaN.f32 %r12, %r11, %r4;
...
; CHECK-SM100-EMPTY:
; CHECK-SM100-NEXT:  // %bb.0:
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fminimum_float_param_0+16];
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fminimum_float_param_0];
; CHECK-SM100-NEXT:    min.NaN.f32 %r9, %r8, %r1, %r2;
; CHECK-SM100-NEXT:    min.NaN.f32 %r10, %r5, %r6, %r7;
; CHECK-SM100-NEXT:    min.NaN.f32 %r11, %r10, %r9, %r3;
; CHECK-SM100-NEXT:    min.NaN.f32 %r12, %r11, %r4;
; CHECK-SM100-NEXT:    st.param.b32 [func_retval0], %r12;
; CHECK-SM100-NEXT:    ret;
...
; CHECK-SM100-EMPTY:
; CHECK-SM100-NEXT:  // %bb.0:
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r1, %r2, %r3, %r4}, [reduce_fminimum_float_reassoc_param_0+16];
; CHECK-SM100-NEXT:    ld.param.v4.b32 {%r5, %r6, %r7, %r8}, [reduce_fminimum_float_reassoc_param_0];
; CHECK-SM100-NEXT:    min.NaN.f32 %r9, %r8, %r1, %r2;
; CHECK-SM100-NEXT:    min.NaN.f32 %r10, %r5, %r6, %r7;
; CHECK-SM100-NEXT:    min.NaN.f32 %r11, %r10, %r9, %r3;
; CHECK-SM100-NEXT:    min.NaN.f32 %r12, %r11, %r4;
...
; CHECK-NEXT:    mov.b32 {%rs5, %rs6}, %r3;
; CHECK-NEXT:    mov.b32 {%rs7, %rs8}, %r4;
; CHECK-NEXT:    mul.lo.s16 %rs9, %rs7, %rs8;
; CHECK-NEXT:    mul.lo.s16 %rs10, %rs5, %rs6;
; CHECK-NEXT:    mul.lo.s16 %rs11, %rs10, %rs9;
; CHECK-NEXT:    mul.lo.s16 %rs12, %rs3, %rs4;
; CHECK-NEXT:    mul.lo.s16 %rs13, %rs1, %rs2;
...
; CHECK-NEXT:    mul.lo.s16 %rs8, %rs5, %rs6;
; CHECK-NEXT:    mul.lo.s16 %rs9, %rs7, %rs8;
; CHECK-NEXT:    mul.lo.s16 %rs10, %rs3, %rs4;
; CHECK-NEXT:    mul.lo.s16 %rs11, %rs1, %rs2;
; CHECK-NEXT:    mul.lo.s16 %rs12, %rs11, %rs10;
; CHECK-NEXT:    mul.lo.s16 %rs13, %rs12, %rs9;
